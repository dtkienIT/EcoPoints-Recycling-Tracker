...
public class EcoPointsRecyclingTracker {
	 ...
	 * The Household objects must be mapped against their respective ID. 
	 * When the application starts, the collection will be empty.
	 */
	private static Map<String, Household> households = new HashMap<>();
	
    public static void main(String[] args) {
        //The method loads any existing saved records before getting into 
        //the while loop to validate user input.
    ...
    /**
     * This method asks for the household ID and validates the household ID. 
     * Then the method collects recycling details, validates the recycling details, 
     * creates a RecyclingEvent, and updates the household record.
     */
    ...
    /**
     * This method displays a list of all registered households. 
     * If no households exist, the method displays a message and exits.
     */
    ...
    /**
     * This method displays all recycling events for a specific household. 
     * This method displays the total weight and total points earned as well.
     */
    ...
    /**
     * This method saves all household data to a file using serialization. 
     * This method ensures that households and their recycling events persist 
    ...
    /**
     * This method loads all household data from a file using deserialization. 
     * If the file exists and contains data, there is Household data that was saved previously. 
     * This method restores the households map. 
     * If the file doesn't exist, the program starts with an empty map.
     */
